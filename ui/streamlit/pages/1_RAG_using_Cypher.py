...
<table>
  ...
  <tr>
    <td>What is in this DB?</td>
    <td>Who are the Aliyevs?</td>
    <td>How is Ilham Aliyev related to Arzu Aliyeva?</td>
  </tr>
  <tr>
    <td>Which Thai company indirectly related to Ilham Aliyev?</td>
    <td>How is Strandlund, Per Stefan connected to Ilham Aliyev?</td>
    <td></td>
  </tr>
</table>
